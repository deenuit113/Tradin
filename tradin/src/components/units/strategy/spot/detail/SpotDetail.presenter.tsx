...
import SpotDetailOption from './option/SpotDetailOption.container';
import { FaCaretUp, FaCaretDown, FaCog } from 'react-icons/fa';
import Breadcrumb from '../../../../commons/breadcrumb/BreadCrumb.container';
import { SpotDetailUIProps } from './SpotDetail.types';
import { useSidebar } from "../../../../../contexts/SidebarContext";
import { transactions } from "./MockTransaction";

export default function SpotDetailUI(props: SpotDetailUIProps): JSX.Element {
        ...
        <S.Container>
            ...
            <S.MainContent sidebarOpen={sidebarOpen} selectedOption={props.selectedOption}>
                <S.WidgetDetailContainer>
                    <S.WidgetHeader>현물 {props.num}</S.WidgetHeader>
                ...
                {props.selectedOption && (
                    <S.WidgetDetailContainer>
                        <S.WidgetHeader>현물 {props.selectedOption}</S.WidgetHeader>
                        <S.WidgetTable  selectedOption={props.selectedOption}>
                            <thead>
                                <tr>
                                    {filteredHeaders.map(header => (
